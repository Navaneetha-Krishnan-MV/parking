...
// import "./Resources/styles/PaymentModal.css"; // Ensure this path is correct
...
//   // const [slotCount, setSlotCount] = useState(20); // Default to 20 for Two Wheeler
...
//     console.log("tcapacitys:", tcapacitys);
//     console.log("fcapacitys:", fcapacitys);
...
//               <input type="text" id="vehicleNo" name="vehicleNo" value={vehicleNo} onChange={(e) => setVehicleNo(e.target.value)} />
//             </div>

//             <div className="input-group">
//               <label htmlFor="vehicleCategory" id="vehicleCategory-label">Enter Category</label>
//               <select id="vehicleCategory" name="vehicleCategory" value={vehicleCategory} onChange={(e) => setVehicleCategory(e.target.value)}>
...
//               <input type="date" id="bookingDate" name="bookingDate" value={bookingDate} onChange={(e) => setBookingDate(e.target.value)} />
//             </div>
