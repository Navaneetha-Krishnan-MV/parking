...
function About() {
    ...
    return (
        <div className="about-container">
            ...
            <div className="about-us">
                <h2  data-aos="fade-down"  data-aos-duration="1500" >About Us</h2>
                <div className="line"  data-aos="zoom-in"  data-aos-duration="1500" ></div>
                <p className="about-paragraph"  data-aos="fade-up"  data-aos-duration="1500" >
                    We are dedicated to providing the best services to our customers. Our team of professionals is committed to ensuring your satisfaction with every interaction.
                </p>
            </div>
            <div className="services">
            ...
            <div className="about-us"  data-aos="zoom-out"  data-aos-duration="1500" >
